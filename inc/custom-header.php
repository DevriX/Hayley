 ...
 *
 * @uses hayley_header_style()
 */
function hayley_custom_header_setup() {
	add_theme_support( 'custom-header', apply_filters( 'hayley_custom_header_args', array(
		'default-image'          => '',
		'default-text-color'     => '000000',
		'width'                  => 1000,
		'height'                 => 250,
		'flex-height'            => true,
		'wp-head-callback'       => 'hayley_header_style',
	) ) );
}
add_action( 'after_setup_theme', 'hayley_custom_header_setup' );

if ( ! function_exists( 'hayley_header_style' ) ) :
/**
